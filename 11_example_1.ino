...
// output the read value to the serial port
  Serial.print("Min:100,raw:");//Serial print
...
if(dist_ema < dist_min) {                  //측정 거리가 180mm보다 작을때
     myservo.writeMicroseconds(_DUTY_MIN);
     analogWrite(PIN_LED, 0);
  }
  else if(dist_ema < dist_max) {          //측정 거리가 180mm보다 크고 360mm보다 작을때
     myservo.writeMicroseconds(550 + (dist_ema-dist_min)*(1850/180));
     analogWrite(PIN_LED, 255);
  }
  else {                                    //측정 거리가 360mm보다 클때
